...
from fractal_stardist_segmentation_task.utils import IteratorConfiguration, MaskingConfiguration
...
def stardist_segmentation_task(
    *,
    ...
    https://github.com/fractal-analytics-platform/fractal-stardist-segmentation-task/fractal-tasks-utils
